...
\begin{document}
    ...
    \section{Education}
        \CVentry[EPFL, Swiss Federal Institute of Technology, Switzerland]
            {Master in Computational Science and Engineering}{2015--2018}
    ...
    \section{Experience}
		\CVentry[G-Therapeutics, Lausanne, Switzerland]
		    {Programming of a 3D robotic body weight support system for gait rehabilitation. My main tasks
		    included writing the safety and the state machine parts of the controller, creating a Graphical User
		    Interface and integrating IMUs, conform to Medical Software norms. Moreover I designed and
		    implemented rehabilitation exercises, and as we had gotten access to Microsoft's Team Foundation
            Server, I decided to extend my contract in order to automatically link it to the code's unit testing.}
            {Feb-Sep 2017}{}{}

    \section{Academic projects}
        \CVentry[EPFL, Biorobotics Laboratory, Lausanne (30 ECTS - Master Thesis)]
            {Biomechanical model of the primates' upper limb: design of stimulation protocols for the
            recovery of reaching movements in tetraplegia.}{Sep-Jan 2018}{}{}
           
        \CVentry[EPFL, Distributed Intelligent Systems and Algorithms Laboratory, Lausanne (8 ECTS)]
        ...
        \CVentry[EPFL, Interdisciplinary Aerodynamics Group, Lausanne (8 ECTS)]
