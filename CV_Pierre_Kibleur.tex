...
\vspace{10pt}
	\emph{With 7+ years experience in imaging, materials \& robotics, I drive multidisciplinary R\&D \\ from concept to delivery with a constant focus on automation and advanced algorithms.}
\vspace{15pt}
    
    \section{Experience}
        \CVentry[Exail, Ostend, Belgium]
            {\BulletPoint Signal processing engineer}
            {2025--present}{AUV-based acoustic reconstruction of sub-surface environments for underwater infrastructure monitoring: 3D algorithm development, lead, and implementation into high TRL platforms.}{}

        \CVentry[UGent Center for X-ray Tomography (UGCT), Ghent, Belgium]
            {\BulletPoint Material and 3D data analysis \\ Full-time continuation of my NDT activities for the industry. Completed several advanced R\&D projects from design proposals to quantitative analyses and reporting. Supervision of research and engineering.\medskip}
            {2022--2025}
            {\BulletPoint Consulting on industrial R\&D \\ Lead external research projects with X-ray CT analysis, which resulted in several improvements at the client side, and the perenisation of this activity within UGCT. Trained engineers and doctoral students.}
            {2018--2022}
    
        \CVentry[Confinis AG, Geneva, Switzerland]
			{\BulletPoint Consulting on regulatory compliance}{2018--2018}{Evaluated the safety of medical prostheses for market certification applications.}{}
    ...
    \section{Competencies}
        \OneLiner{Coding}{Python, C/C++, Matlab, Bash, shell, CUDA, BASIC, C\#, LaTeX}{}
	...
	\section{\TwoColumns[Languages]{Hobbies}}	
		...
		\OneLiner[true]{Dutch}{Basics but learning \hfill}{Trainee sailor}	        
