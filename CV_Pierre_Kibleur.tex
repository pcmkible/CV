...
\vspace{10pt}
	\emph{Senior analyst with broad experience in materials, imaging \& robotics, I lead multidisciplinary \\R\&D from concept to delivery with a constant focus on automation and advanced algorithms.}
\vspace{15pt}
    
    \section{Experience}
        \CVentry[Exail, Ostend, Belgium]
            {\BulletPoint Signal processing engineer}
            {2025--present}{Sub-surface imaging for naval drones: 3D sonar development and implementation (TRL 6+).}{}

        \CVentry[UGent Center for X-ray Tomography (UGCT), Ghent, Belgium]
            {\BulletPoint 3D data engineer \\ Non-destructive testing of materials and assemblies for the industry. Led contractual projects from initial design proposals to quantitative analyses and reporting. Supervised internal and external researchers.\medskip}
            {2022--2025}
            {\BulletPoint Consulting on industrial R\&D \\ Undertook external projects on materials (composites, metals) using X-ray CT, which led to improvements in material durability and manufacturing process optimizations. Trained engineers and doctoral students.}
            {2018--2022}
    
        \CVentry[Confinis AG, Geneva, Switzerland]
			{\BulletPoint Consulting on regulatory compliance}{2018--2018}{Evaluated the viability of medical prostheses in preparation for marketing application dossiers.}{}
	...
	\section{\TwoColumns[Languages]{Hobbies}}	
		...
		\OneLiner[true]{Dutch}{Elementary \hfill}{Trainee sailor}	        
