...
\vspace{15pt}
    ...
    \section{Experience}
        \CVentry[Exail Robotics, Ostend, Belgium]
            {\BulletPoint R\&D engineer}
            {2025--present}{Development and integration of 3D sonar algorithms to do underwater demining with AUVs and TUVs.}{}
        ...
        \CVentry[UGent Center for X-ray Tomography (UGCT), Ghent, Belgium]
            ...
            {2022--2025}
            {\BulletPoint Doctoral researcher \\ Quantified the deterioration of MDF composite materials with X-rays, image processing, and FEM simulations to improve their durability. Took an active part in many external R\&D projects.}
            {2018--2022}
    ...
    \section{Competencies}
        ...
        \OneLiner{Communication}{Author of 22 peer-reviewed articles, regular presenter at conferences and meetings}{}
        
	\section{\TwoColumns[Languages]{Hobbies}}	
		\OneLiner[true]{English/French}{Fluent}{Rowing: twice champion of Belgium}
