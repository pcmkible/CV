...
\SetFirstName{Pierre}
\SetLastName{Kibleur}
\SetTitle{Engineer in Computational Sciences}
...
\begin{document}
    ...
    \section{Experience}
		\CVentry[UNIFR, University of Fribourg, Switzerland]
            {Preparing a peer-reviewed scientific publication based on my Master Thesis}
            {Mar-(Jul 2018)}{}{}
    ...
    \section{\TwoColumns[Languages]{Free time}}
        \OneLiner[English]{Advanced (C1) \hfill}{Tenor saxophone}
        \OneLiner[Russian]{Basics (A2) \hfill}{Western concert flute}
        \OneLiner[French]{Native speaker \hfill}{Running}
