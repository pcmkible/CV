...
\begin{document}
    ...
    \section{Technical skills}
        ...
        \OneLiner[Coding]{C/C++, Python, Matlab, Bash, shell, CUDA, Basic, C\#}{}
        ...
        \OneLiner[Software]{Git, Dragonfly, Avizo, VGStudio Max, Fiji, Abaqus, Solid Works, Fusion 360}{}
        \OneLiner[Environments]{Linux/Windows, Vim, Atom, Visual Studio, Jupyter, Overleaf}{}
        \OneLiner[Office]{Microsoft Office Suite, LaTeX, Visio}{}
